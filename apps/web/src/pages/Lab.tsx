...
const Lab = () => {
  ...
  if (!mission) {
    return (
      <div className="flex flex-col h-[calc(100vh-60px)] -mt-6 p-6 max-w-[1920px] mx-auto animate-fade-in items-center justify-center">
         <div className="text-[var(--text-muted)] animate-pulse">Initializing Castle Node...</div>
      </div>
    );
  }
